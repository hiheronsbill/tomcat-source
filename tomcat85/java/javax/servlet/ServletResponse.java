 ...
 * <p>
 * The charset for the MIME body response can be specified explicitly using the {@link #setCharacterEncoding} and
 * {@link #setContentType} methods, or implicitly using the {@link #setLocale} method. Explicit specifications take
 * precedence over implicit specifications. If no charset is specified, ISO-8859-1 will be used. The
 * <code>setCharacterEncoding</code>, <code>setContentType</code>, or <code>setLocale</code> method must be called
...
public interface ServletResponse {
    ...
    /**
     * Returns the name of the character encoding (MIME charset) used for the body sent in this response. The character
     * encoding may have been specified explicitly using the {@link #setCharacterEncoding} or {@link #setContentType}
     * methods, or implicitly using the {@link #setLocale} method. Explicit specifications take precedence over implicit
     * specifications. Calls made to these methods after <code>getWriter</code> has been called or after the response
     * has been committed have no effect on the character encoding. If no character encoding has been specified,
     ...
     * the character encoding has already been set by {@link #setContentType} or {@link #setLocale}, this method
     * overrides it. Calling {@link #setContentType} with the <code>String</code> of <code>text/html</code> and calling
     * this method with the <code>String</code> of <code>UTF-8</code> is equivalent with calling
